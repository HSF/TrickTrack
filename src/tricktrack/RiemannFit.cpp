...
Matrix2Nd cov_radtocart(const Matrix2xNd& p2D,
...
VectorNd Weight_circle(const Matrix2xNd& /*p2D*/, const MatrixNd& cov_rad_inv) {
...
VectorNd Weight_line(const ArrayNd& x_err2, const ArrayNd& y_err2, const double& tan_theta) {
...
int Charge(const Matrix2xNd& p2D, const Vector3d& par_uvr) {
